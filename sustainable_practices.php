...
document.querySelectorAll('.open-overlay').forEach(item => {
    ...
    <div class="content">
        <img src="images/sus1.png" alt="About Image 1">
        <img src="images/sus2.png" alt="About Image 2">
        <img src="images/sus3.png" alt="About Image 3">
        <img src="images/sus4.png" alt="About Image 4">
    </div>
