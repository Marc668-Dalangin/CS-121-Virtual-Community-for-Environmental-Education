...
document.querySelectorAll('.open-overlay').forEach(item => {
    ...
    <div class="content">
        <img src="images/Bio1.png" alt="About Image 1">
        <img src="images/Bio2.png" alt="About Image 2">
        <img src="images/Bio3.png" alt="About Image 3">
        <img src="images/Bio4.png" alt="About Image 4">
