...
document.querySelectorAll('.open-overlay').forEach(item => {
    ...
    <!-- Main Content -->
    <div class="content">
        <img src="images/Com3.png" alt="About Image 1">
        <img src="images/Com4.png" alt="About Image 2">
        <img src="images/Com5.png" alt="About Image 3">
        <img src="images/Com6.png" alt="About Image 4">
    </div>
