...
document.querySelectorAll('.open-overlay').forEach(item => {
    ...
    <!-- Main Content -->
    <div class="content">
        <img src="images/CLIMATE.png" alt="About Image 1">
        <img src="images/CLIMATE2.png" alt="About Image 2">
        <img src="images/CLIMATE3.png" alt="About Image 3">
        <img src="images/CLIMATE4.png" alt="About Image 4">
    </div>
