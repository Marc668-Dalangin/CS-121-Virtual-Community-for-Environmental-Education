...
document.querySelectorAll('.open-overlay').forEach(item => {
    ...
    <!-- Main Content -->
    <div class="content">
        <img src="images/Eco1.png" alt="About Image 1">
        <img src="images/Eco2.png" alt="About Image 2">
        <img src="images/Eco3.png" alt="About Image 3">
        <img src="images/Eco4.png" alt="About Image 4">
    </div>
